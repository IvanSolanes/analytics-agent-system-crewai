...
narrator_task = Task(
    description=(
        ...
        "   - IMPORTANT: Never make claims about WHY a feature was "
        "transformed or HOW it improves predictions unless a specific "
        "metric proves it. Only state what the numbers show.\n"
